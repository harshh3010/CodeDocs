...
public class EditorService {
    ...
    public static void transferControl(TransferControlRequest request) {
        ...
        String codeDocId = request.getCodeDocId();
